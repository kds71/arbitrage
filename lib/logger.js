...
var levelOrder = [C.LOG_LEVEL_FATAL, C.LOG_LEVEL_ERROR, C.LOG_LEVEL_WARN, C.LOG_LEVEL_INFO, C.LOG_LEVEL_DEBUG, C.LOG_LEVEL_VERBOSE];
...
class Logger {
    ...
    createLogFile() {
        ...
        var timestamp = this.timestamp(),
            basedir = path.join(this.config['directory'], this.config['app-id'], timestamp.date),
